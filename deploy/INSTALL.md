...
chmod 700 deploy/install-centos7.sh deploy/install-stack-common.sh
./deploy/install-centos7.sh
```
...
```bash
cd /var/javaCode/yc-page
chmod 700 deploy/install-ubuntu.sh deploy/install-stack-common.sh
